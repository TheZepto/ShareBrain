...
(boolean_input, boolean_target) = sharescraper.proc_share_bool_inp_targ(
	historical_data,
	days_of_data=30)
...
X_train, X_test, y_train, y_test = train_test_split(
	boolean_input, boolean_target, test_size=test_split, random_state=random_number)
...
clf = MLPClassifier(
	activation = 'tanh',
	solver ='adam',
	hidden_layer_sizes=(1000,500,100,50,20,10,5),
	alpha = 1,
	max_iter = 300,
	tol = 1E-5,
	warm_start = False,
